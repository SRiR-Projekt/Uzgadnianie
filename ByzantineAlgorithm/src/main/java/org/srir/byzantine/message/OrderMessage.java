package org.srir.byzantine.message;

import java.util.LinkedList;
import java.util.List;

import org.srir.byzantine.Order;
...
public class OrderMessage extends Message {
	...
	{
		return "Wiadomosc rozkazu [rozkaz=" + order + ", max zdrajcy=" + maxTraitors + ", przetworzone=" + alreadyProcessed + "]";
	}
}
